...
h2. Estimate the inner product (to be written)
...
** <code>create()</code>, <code>copy()</code> and <code>shrink()</code> accept <var>FILE_TRUNCATE</var>.
